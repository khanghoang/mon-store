...
const foodItems: FoodItem[] = [
  { id: 1, name: "Margherita Pizza", price: 12.99, image: "/placeholder.svg?height=100&width=100", type: 'pizza', details: "Tomato sauce, mozzarella, basil" },
  { id: 2, name: "Pepperoni Pizza", price: 14.99, image: "/placeholder.svg?height=100&width=100", type: 'pizza', details: "Tomato sauce, mozzarella, pepperoni" },
  { id: 3, name: "Berry Blast Smoothie", price: 6.99, image: "/placeholder.svg?height=100&width=100", type: 'smoothie', details: "Strawberries, blueberries, banana, yogurt" },
  { id: 4, name: "Green Machine Smoothie", price: 7.99, image: "/placeholder.svg?height=100&width=100", type: 'smoothie', details: "Spinach, kale, banana, mango, chia seeds" },
]
...
export default function FoodCartPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-center">Your Food Cart</h1>
